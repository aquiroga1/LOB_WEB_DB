...
class Subjects(models.Model):
    ...
    birth_date = models.DateField(auto_now=False, null=False, blank=False)
    ...
    skin_color = models.CharField(max_length=20, null=True, blank=True, default='No info', choices=skin_color_choices)
    handedness = models.CharField(max_length=20, null=True, blank=True, default='No info', choices=handedness_choices)
    scholar_level = models.CharField(max_length=20, null=False, blank=True, default='No info', choices=scholar_level_choices)
